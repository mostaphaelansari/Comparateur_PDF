def compare_rvd_images():
    if  {Changement batterie} =="Non" && {Changement électrodes pédiatriques} =="Non" && {Changement électrodes adultes} =="Non" && {Changement batterie} =="Non" && {Changement électrodes pédiatriques} =="Non" && {Changement électrodes adultes} =="Non":
        try:
            results = {}
